      ...
      <SecondSection>
        ...
        <div>
          ...
          <ul>
            ...
            <li>Proven experience working in agile environment and cross functional teams</li>
            <li>Experience with Docker/Kubernetes - Advantage</li>
          </ul>
        </div>
      </SecondSection>
    </Container>
